        ...
        <nav style={{ zIndex: 3333 }} className="relative flex justify-end sm:justify-center gap-0 w-full bg-neutral-50 dark:bg-custom-900">
            ...
            <div className="content-center m-0 col-span-10 justify-center hidden sm:flex" id="navbar-default">
                <ul className="flex flex-row mt-0 text-md text-gray-900 dark:text-gray-300 ">
                    ...
                    <li className="self-center transition duration-300 ease-in-out hover:bg-opacity-25 active:bg-opacity-80 hover:bg-rose-500 ">
                    ...
                    <li className="self-center transition duration-300 ease-in-out hover:bg-opacity-20 active:bg-green-600 active:bg-opacity-80 hover:bg-green-400">
                    ...
                    <li className="self-center transition duration-300 ease-in-out hover:bg-opacity-20 active:bg-violet-900 active:bg-opacity-90 hover:bg-violet-500">
